...
from src import print_weights, RNN, train, evaluate, MemoryDataset
...
DATASET: Literal["memory"] = sys.argv[1]
...
train_dataset = MemoryDataset(N, K, NUM_SAMPLES)
val_dataset = MemoryDataset(N, K, NUM_SAMPLES//10)
